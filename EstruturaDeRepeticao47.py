...
print(f'Atelta: {nome_atleta}')

for i in lista_nota:
    print(f'Nota: {i}')

melhor_nota = max(lista_nota)
pior_nota = min(lista_nota)

del (lista_nota[(lista_nota.index(melhor_nota))])
del (lista_nota[(lista_nota.index(pior_nota))])
