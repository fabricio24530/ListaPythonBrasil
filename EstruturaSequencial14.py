...
excesso_de_quilos = peso - 50
multa = excesso_de_quilos * 4

if excesso_de_quilos <= 0:
    print(f'''Quantidade de peixe: {peso}Kg
              Excesso de peixe: -
              Multa: -''')
elif excesso_de_quilos > 0:
    print(f'''Quantidade de peixe: {peso}Kg
                  Excesso de peixe: {excesso_de_quilos}Kg
                  Multa: R$ {multa}''')
